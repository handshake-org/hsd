...
class ChainDB {
  ...
  constructor(options) {
    ...
    this.cdb = new CDB(this.db, this.network);
  ...
  async saveView(view) {
    ...
    return this.cdb.saveView(this.current, view);
  }
  ...
  async connectBlock(entry, block, view) {
    ...
    await this.cdb.connectBlock(this.current, block);
  ...
  async disconnectBlock(entry, block) {
    ...
    await this.cdb.disconnectBlock(entry, block, view);
