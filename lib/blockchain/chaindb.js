...
class ChainDB {
  ...
  constructor(options) {
    ...
    this.trieBucket = this.db.bucket(layout.k.build());
  ...
  start() {
    ...
    this.snapshot = this.trie.snapshot();
  ...
  /**
   * Commit the current trie snapshot.
   */

  commitSnapshot() {
    const b = this.trieBucket.wrap(this.current);
