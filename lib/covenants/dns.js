...
function append(res, domain, zone) {
  const msg = res.clone();
  msg.question = msg.question.slice();
  msg.answer = msg.answer.slice();
  msg.authority = msg.authority.slice();
  msg.additional = msg.additional.slice();
  ...
  _append(msg.answer, domain, zone);
  _append(msg.authority, domain, zone);
  _append(msg.additional, domain, zone);
