...
class NameDB {
  ...
  async isBiddable(nameHash, height, hardened) {
    const result = await this.getAuctionState(nameHash, height, hardened);
    return result.state === states.BIDDING;
  }
