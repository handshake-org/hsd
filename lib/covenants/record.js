...
const {Compressor, Decompressor} = require('./compress');
...
r.ns.push(new Target(rtypes.INAME, 'example1.com.icann'));
r.ns.push(new Target(rtypes.INAME, 'example2.com.icann'));
r.ns.push(new Target(rtypes.INAME, 'example1.org.icann'));
r.ns.push(new Target(rtypes.INAME, 'example2.org.icann'));
r.ns.push(new Target(rtypes.INAME, 'example3.com.icann'));
r.ns.push(new Target(rtypes.INAME, 'example4.com.icann'));
r.ns.push(new Target(rtypes.INAME, 'example3.net.icann'));
r.ns.push(new Target(rtypes.INAME, 'example4.net.icann'));
