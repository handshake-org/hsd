...
class WalletDB extends EventEmitter {
  ...
  async getAuctionState(nameHash, height, hardened = false) {
    return this.client.getAuctionState(nameHash, height, hardened);
  }
  ...
  async isBiddable(nameHash) {
    return this.client.isBiddable(nameHash);
  }
