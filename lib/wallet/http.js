...
class HTTP extends Server {
  ...
  initRouter() {
     ...
     *     tags: 
     *       - wallet 
     *     summary: Rescan the blockchain for wallet transactions.
     *     description: Initiates a blockchain rescan for the walletdb. Wallets will be rolled back to the specified height (transactions above this height will be unconfirmed).
     *     requestBody:
     *       content:
     *         application/json:
     *           schema:
