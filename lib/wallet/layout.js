 ...
 *   A[hash] -> name record (name record by name hash)
 *   U[hash] -> name undo record (name undo record by tx hash)
 *   i[hash][hash][index] -> bid (BlindBid by name hash + tx hash + index)
 *   B[hash][hash][index] -> reveal (BidReveal by name hash + tx hash + index)
 *   v[hash] -> blind (Blind Value by blind hash)
 *   o[hash] -> tx hash (tx hash by name hash)
 */
