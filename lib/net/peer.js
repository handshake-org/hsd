...
const peerTypesByVal = {
  [peerTypes.STANDARD]: 'STANDARD',
  [peerTypes.BRONTIDE]: 'BRONTIDE'
};
...
class Peer extends EventEmitter {
  ...
  accept(socket) {
    ...
    switch (this.type) {
      case peerTypes.STANDARD:
        this.connected = true;
        this.time = Date.now();
        break;
      case peerTypes.BRONTIDE:
  ...
  peerType() {
    return peerTypesByVal[this.type];
  }
  ...
  isStandard() {
    return this.type === peerTypes.STANDARD;
  }
  ...
  isBrontide() {
    return this.type === peerTypes.BRONTIDE;
  }
