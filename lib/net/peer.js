...
class Peer extends EventEmitter {
  ...
  increaseBan(banScore, dosScore, time) {
    ...
    if (dosScore > 0) {
      ...
      // increaseBan with a dosScore multiple times will increase the overall
      // banscore in a logarithmically decaying fashion to penalize short
      // bursts of repeated requests.  The dosScore decays back to 0 in 30mins,
      // i.e. 1800s.
      ...
      this.dosScore += dosScore;
      this.banScore += Math.floor(this.dosScore);
