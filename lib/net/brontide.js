...
class BrontideStream extends Brontide {
  ...
  /**
   * Accept a brontide connection from a remote peer.
   *
   * `this.init` is called with `false` because the
   * handshake is not being initialized locally, the
   * remote node is initializing the connection.
   *
   * @param {net.Socket} - socket
   * @param {Buffer} - ourKey
   * @returns {BrontideStream}
   */
  ...
  /**
   * Create a brontide connection with a remote peer.
   *
   * @param {net.Socket} - socket
   * @param {Buffer} - ourKey
   * @param {Buffer} - theirKey
   * @returns {BrontideStream}
   */
