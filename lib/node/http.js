 ...
 *           format: float
 *         state:
 *           $ref: '#/components/schemas/ResponseInfoChainState'
 *     ResponseInfoPool:
 *       properties:
 *         host:
 *           type: string
 ...
 *           type: string
 *         chain:
 *           $ref: '#/components/schemas/ResponseInfoChain'
 *         pool:
 *           $ref: '#/components/schemas/ResponseInfoPool'
 *         mempool:
 *           $ref: '#/components/schemas/ResponseInfoMempool'
 *         time:
 *           $ref: '#/components/schemas/ResponseInfoTime'
 *         memory:
 *           $ref: '#/components/schemas/ResponseInfoMemory'
 */
