    ...
    this.get('/', async (req, res) => {
      ...
      res.json(200, {
        ...
        pool: {
          ...
          outbound: {
            standard: this.pool.peers.standard.outbound,
            brontide: this.pool.peers.brontide.outbound
          },
          inbound: {
            standard: this.pool.peers.standard.inbound,
            brontide: this.pool.peers.brontide.inbound
          }
        },
        mempool: {
          tx: totalTX,
