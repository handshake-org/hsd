...
class FullNode extends Node {
  ...
  constructor(options) {
    ...
    this.ns = new RootServer(this, 'udp4');
    this.rs = new RecursiveServer(this, 'udp4');
  ...
  async open() {
    ...
    await this.ns.open(this.network.nsPort, '127.0.0.1');
    await this.rs.open(this.network.rsPort, '127.0.0.1');
