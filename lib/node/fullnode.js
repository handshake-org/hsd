...
class FullNode extends Node {
  ...
  constructor(options) {
    ...
    this.pool = new Pool({
      ...
      brontidePublicHost: this.config.str('brontide-public-host'),
      brontidePublicPort: this.config.uint('brontide-public-port'),
      brontideHost: this.config.str('brontide-host'),
