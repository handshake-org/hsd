...
const {RootServer} = require('../dns/server');
...
class FullNode extends Node {
  ...
  constructor(options) {
    ...
    this.root = new RootServer(this.chain.cdb, 'udp4');
  ...
  async open() {
    ...
    await this.root.open(this.network.dnsPort, '127.0.0.1');
