/*!
 * workerpool.js - worker processes for hsk
...
class WorkerPool extends EventEmitter {
  ...
  constructor(options) {
    ...
    this.size = getCores();
    this.timeout = 120000;
    this.file = process.env.HSKD_WORKER_FILE || 'worker.js';
...
class Worker extends EventEmitter {
  ...
  listen() {
    ...
    this.sendEnv({
      HSKD_WORKER_NETWORK: Network.type,
      HSKD_WORKER_ISTTY: process.stdout
        ? (process.stdout.isTTY ? '1' : '0')
        : '0',
      HSKD_WORKER_IGNORE: ownership.ignore ? '1' : '0'
    });
  }
