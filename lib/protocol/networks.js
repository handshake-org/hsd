...
main.halvingInterval = 680000; // XXX 340000
...
main.coinbaseMaturity = 400; // XXX 200
...
main.pow.targetWindow = 17; // XXX 9
...
main.pow.targetSpacing = 2.5 * 60; // XXX 5 * 60
...
main.names = {
  ...
  /**
   * Max name updates per block.
   * @const {Number}
   */

  maxUpdates: 250, // XXX 500
...
main.block = {
  ...
  pruneAfterHeight: 4000, // XXX 2000

  /**
   * Safe number of blocks to keep.
   */

  keepBlocks: 1152, // XXX 576
...
main.activationThreshold = 7664; // XXX 3832
...
main.minerWindow = 8064; // XXX 4032
...
testnet.halvingInterval = 680000; // XXX 340000
testnet.coinbaseMaturity = 400; // XXX 200
...
testnet.pow.targetWindow = 17; // XXX 9
testnet.pow.targetSpacing = 2.5 * 60; // XXX 5 * 60
...
testnet.block = {
  pruneAfterHeight: 4000, // XXX 2000
  keepBlocks: 40000, // XXX 20000
  maxTipAge: 24 * 60 * 60,
  slowHeight: 0,
  launchDate: 1526155200
};

testnet.activationThreshold = 6048; // XXX 3024

testnet.minerWindow = 8064; // XXX 4032
...
regtest.halvingInterval = 10000; // XXX 5000
...
regtest.pow.targetWindow = 17; // XXX 9
regtest.pow.targetSpacing = 2.5 * 60; // XXX 5 * 60
...
regtest.activationThreshold = 432; // XXX 216

regtest.minerWindow = 576; // XXX 288
...
simnet.halvingInterval = 680000; // XXX 340000
simnet.coinbaseMaturity = 25; // XXX 12
...
simnet.pow.targetWindow = 17; // XXX 9
simnet.pow.targetSpacing = 2.5 * 60; // XXX 5 * 60
...
simnet.names = {
  auctionStart: 0,
  rolloutInterval: 5, // XXX 3
  renewalWindow: 10000, // XXX 5000
  renewalPeriod: 5000, // XXX 2500
  renewalMaturity: 100, // XXX 50
  claimPeriod: 300000, // XXX 150000
  biddingPeriod: 100, // XXX 50
  revealPeriod: 200, // XXX 100
  totalPeriod: 100 + 200, // XXX 50 + 100
  treeInterval: 10, // XXX 5
  maxUpdates: 250, // XXX 500
  transferLockup: 20, // XXX 10
  revocationDelay: 100, // XXX 50
  auctionMaturity: 100 + 200 + 100, // XXX 50 + 100 + 50
  noRollout: false,
  noReserved: false
};
...
simnet.activationThreshold = 300; // XXX 150

simnet.minerWindow = 400; // XXX 200
