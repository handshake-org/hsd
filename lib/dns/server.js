...
class RootServer extends DNSServer {
  ...
  async response(req, rinfo) {
    ...
    if (qs.name === '.') {
      ...
      switch (qs.type) {
        ...
        case types.NS:
          ...
          dnssec.signMessage(res, '.', key.zsk, key.zskPriv);
          break;
        case types.SOA:
        ...
        case types.DNSKEY:
          ...
          dnssec.signMessage(res, '.', key.ksk, key.kskPriv);
          break;
        case types.DS:
    ...
    dnssec.signMessage(res, tld, key.zsk, key.zskPriv);
    dnssec.signMessage(res, '.', key.zsk, key.zskPriv);
  ...
  async resolve(req, rinfo) {
    ...
    if (!req.isDNSSEC())
      return dnssec.filterMessage(res, type);
