...
// Index
hsd.define('indexer', './indexer');
hsd.define('Indexer', './indexer/indexer');
hsd.define('ChainClient', './indexer/chainclient');
hsd.define('TXIndexer', './indexer/txindexer');
hsd.define('AddrIndexer', './indexer/addrindexer');
