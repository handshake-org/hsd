...
const AIRDROP_ROOT = Buffer.from(
  '3283b85aaea4738f936b9fd62251b4358683a7ecd2b930d228edcda7482c4a45',
  'hex');

const AIRDROP_LEAVES = 203606;
const AIRDROP_SUBLEAVES = 60;
const AIRDROP_DEPTH = 18;
const AIRDROP_SUBDEPTH = 6;
const AIRDROP_REWARD = 4640280756;

const FAUCET_ROOT = Buffer.from(
  '4c6cbc2f051396836be7cadfcb5ed64f9b538ab90f27aa06c3a5333c2eccc0a1',
  'hex');

const FAUCET_LEAVES = 1348;
