...
const AIRDROP_ROOT = Buffer.from(
  '5bb6a53bbd3f7496a7ef040a0ec4c08163d34cdac9e8e2d53631078f4455518f',
  'hex');

const AIRDROP_LEAVES = 216192;
const AIRDROP_SUBLEAVES = 60;
const AIRDROP_DEPTH = 18;
const AIRDROP_SUBDEPTH = 6;
const AIRDROP_REWARD = 4370822008;

const FAUCET_ROOT = Buffer.from(
  'f0f9226709f45c64aa428fcea560a4549d7764dee736a5eaea18de3b113345e8',
  'hex');

const FAUCET_LEAVES = 1405;
