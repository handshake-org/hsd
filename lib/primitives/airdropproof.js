...
const AIRDROP_ROOT = Buffer.from(
  'e9049c2109b7166544d1c1f11692d567a40c42c8b14c7d9c2327dadf164d3fcd',
  'hex');

const AIRDROP_LEAVES = 203578;
const AIRDROP_SUBLEAVES = 60;
const AIRDROP_DEPTH = 18;
const AIRDROP_SUBDEPTH = 6;
const AIRDROP_REWARD = 4639511876;

const FAUCET_ROOT = Buffer.from(
  '46f10337bb5f91adb554f369405b802e864bfc59ea48a6ca2d2e33128286a5ce',
  'hex');

const FAUCET_LEAVES = 1406;
const FAUCET_DEPTH = 11;

const TREE_LEAVES = AIRDROP_LEAVES + FAUCET_LEAVES;

const MAX_PROOF_SIZE = 3400; // 3339
