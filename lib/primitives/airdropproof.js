...
const AIRDROP_ROOT = Buffer.from(
  'eb68925d23b6275ada142d95c413d8cb653563e0b865ed73d6fc135b28b6aa25',
  'hex');

const AIRDROP_LEAVES = 216198;
const AIRDROP_SUBLEAVES = 10;
const AIRDROP_DEPTH = 18;
const AIRDROP_SUBDEPTH = 4;
const AIRDROP_REWARD = 4247013818;

const FAUCET_ROOT = Buffer.from(
  '87efa19285c336e69019e01baa48d1e2cbab150769f83ed40625bf203b0757a0',
  'hex');

const FAUCET_LEAVES = 1331;
const FAUCET_DEPTH = 11;

const TREE_LEAVES = AIRDROP_LEAVES + FAUCET_LEAVES;

const MAX_PROOF_SIZE = 3400; // 3284
