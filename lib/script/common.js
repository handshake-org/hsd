...
exports.opcodes = {
  ...
  OP_SHA3: 0xac,
  OP_KECCAK: 0xad,
  OP_CODESEPARATOR: 0xae,
  OP_CHECKSIG: 0xaf,
  OP_CHECKSIGVERIFY: 0xb0,
  OP_CHECKMULTISIG: 0xb1,
  OP_CHECKMULTISIGVERIFY: 0xb2,
  OP_CHECKLOCKTIMEVERIFY: 0xb3,
  OP_CHECKSEQUENCEVERIFY: 0xb4,
...
exports.opcodesByVal = {
  ...
  0xac: 'OP_SHA3',
  0xad: 'OP_KECCAK',
  0xae: 'OP_CODESEPARATOR',
  0xaf: 'OP_CHECKSIG',
  0xb0: 'OP_CHECKSIGVERIFY',
  0xb1: 'OP_CHECKMULTISIG',
  0xb2: 'OP_CHECKMULTISIGVERIFY',
  0xb3: 'OP_CHECKLOCKTIMEVERIFY',
  0xb4: 'OP_CHECKSEQUENCEVERIFY',
...
exports.isHashType = function isHashType(sig) {
  ...
  const type = sig[sig.length - 1]
    & ~exports.hashType.NOINPUT
    & ~exports.hashType.ANYONECANPAY;
